...
import { createFilmCardTemplate } from './view/container-card-view';
import { createUserProfileTemplate } from './view/header-user-view';
import { createFilmCardElementsTemplate } from './view/movie-card-view';
import { createButtonShowMoreTemplate } from './view/film-list-show-view';
import { createPopupTemplate } from './view/site-popup-element-view';
import { createSiteStatTemplate } from './view/site-statistick-view';
